    ...
    >
        ...
        {spotlightStream ? (
          ...
          >
            <VideoPlayer
              ...
              isMicMuted={spotlightStream.isMicMuted}
            />
      ...
      >
        <div className="flex space-x-2 overflow-x-auto pb-2 h-full">
          {localStream && (
            <div
              className={`flex-shrink-0 rounded-lg cursor-pointer ${
            ...
            >
              <VideoPlayer stream={localStream} username="You" isLocal={true} isMicMuted={false} />
